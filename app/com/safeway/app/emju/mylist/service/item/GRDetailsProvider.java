...
@Singleton
public class GRDetailsProvider extends OFRDetailsProvider<OfferDetail> {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(GRDetailsProvider.class);
	...
	public Collection<ShoppingListItemVO> getItemDetails(Map<String, OfferDetail> offerDetailMap, Map<String, ShoppingListItem> itemMap,
		...
		try {
			...
			LOGGER.error("Exception-->GRDetailsProvider>>setOfferDetails-->  "
		...
		LOGGER.info("GRDetailsProvider setOfferDetails <<");
