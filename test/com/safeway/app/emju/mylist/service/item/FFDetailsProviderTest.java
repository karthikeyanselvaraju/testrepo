...
public class FFDetailsProviderTest {
	static {
        System.setProperty("config.file", "conf/mylist-local.conf");
    }

    private static final Logger LOGGER = LoggerFactory.getLogger(FFDetailsProviderTest.class);
    private static Application fakeApp;
    private FFDetailsProvider ffDetailsProvider;
    ...
    @Before
    public void setup() {
    	ffDetailsProvider = new FFDetailsProvider();
    }
    ...
    public void testgetItemDetailsForSuccess() throws Exception {
    	...
    	Collection<ShoppingListItemVO> result = ffDetailsProvider.getItemDetails(itemMap, vo, matchedOffers);
