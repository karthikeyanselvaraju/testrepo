...
public class RECDetailsProviderTest {
	static {
        System.setProperty("config.file", "conf/mylist-local.conf");
    }

    private static final Logger LOGGER = LoggerFactory.getLogger(RECDetailsProviderTest.class);
    private static Application fakeApp;
    private RECDetailsProvider recDetailsProvider;
    @Mock
    ...
    @Before
    public void setup() {
    	recDetailsProvider = new RECDetailsProvider();
    }
    ...
    public void testgetItemDetailsForSuccess() throws Exception {
    	...
    	Collection<ShoppingListItemVO> result = recDetailsProvider.getItemDetails(itemMap, vo, matchedOffers);
