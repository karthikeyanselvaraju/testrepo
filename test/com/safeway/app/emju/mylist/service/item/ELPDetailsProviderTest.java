...
public class ELPDetailsProviderTest {
	static {
        System.setProperty("config.file", "conf/mylist-local.conf");
    }

    private static final Logger LOGGER = LoggerFactory.getLogger(ELPDetailsProviderTest.class);
    private static Application fakeApp;
    private ELPDetailsProvider elpDetailsProvider;
    ...
    @Before
    public void setup() {
    	elpDetailsProvider = new ELPDetailsProvider();
    }
    ...
    public void testgetItemDetailsForSuccess() throws Exception {
    	...
    	Collection<ShoppingListItemVO> result = elpDetailsProvider.getItemDetails(itemMap, vo, matchedOffers);
