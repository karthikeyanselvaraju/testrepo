...
public class MCSDetailsProviderTest {
	static {
        System.setProperty("config.file", "conf/mylist-local.conf");
    }

    private static final Logger LOGGER = LoggerFactory.getLogger(MCSDetailsProviderTest.class);
    private static Application fakeApp;
    private MCSDetailsProvider mcsDetailsProvider;
    ...
    @Before
    public void setup() {
    	mcsDetailsProvider = new MCSDetailsProvider();
    }
    ...
    public void testgetItemDetailsForSuccess() throws Exception {
    	...
    	Collection<ShoppingListItemVO> result = mcsDetailsProvider.getItemDetails(itemMap, vo, matchedOffers);
