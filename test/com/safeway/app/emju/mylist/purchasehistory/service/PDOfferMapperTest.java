...
public class PDOfferMapperTest {

    private final static Logger LOGGER = LoggerFactory.getLogger(PDOfferMapperTest.class);

    private static FakeApplication fakeApp;
    private PDOfferMapper mapper;
    ...
    public void testPDmapOfferForSuccess() throws Exception {
    	...
    	OfferStorePrice offerStorePrice = new OfferStorePrice();
    	offerStorePrice.setRegularPrice(567.00);
    	...
    	AllocatedOffer actual = mapper.mapOffer(offerDetail, offerStorePrice, offerClipStatus, timezone);
